...
public class CodeGenerator {
    ...
    //作者、包名、去除表前缀
    private static final String author = "Mr.Yu";
    private static final String package_name = "com.example.selection";
    //private static final String TABLE_PREFIX = "tb_";

    //数据库
    private static final String url = "jdbc:mysql://localhost:3306/example?useUnicode=true&useSSL=false&characterEncoding=utf8";
